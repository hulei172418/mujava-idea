...
public class MethodLevelMutator  extends mujava.op.util.Mutator
{
    ...
    public static String getMethodSignature(MethodDeclaration p)
    {
        //remover the generics in the return type
        String temp = p.getReturnType().toString();
        ...
        for (int i = 0; i < pars.size(); i++)
        {
            ...
            String tempParameter = pars.get(i).getTypeSpecifier().toString();
    ...
    public static String getConstructorSignature(ConstructorDeclaration p)
    {
