...
public class IOD extends DeclAnalyzer
{
    ...
    * @throws MOPException
    */
   public void generate(CompilationUnit comp_unit, OJClass clazz) throws MOPException
   {
   ...
   public IOD( Environment oj_param0, OJClass oj_param1, ClassDeclaration oj_param2 )
   {
      super( oj_param0, oj_param1, oj_param2 );
   }

   public IOD( Class oj_param0, MetaInfo oj_param1 )
   {
