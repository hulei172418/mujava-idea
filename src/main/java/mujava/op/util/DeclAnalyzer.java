...
public class DeclAnalyzer extends OJClass
{
    ...
    public DeclAnalyzer( Environment oj_param0, OJClass oj_param1, openjava.ptree.ClassDeclaration oj_param2 )
    {
        super( oj_param0, oj_param1, oj_param2 );
    }

    public DeclAnalyzer( Class oj_param0, MetaInfo oj_param1 )
    {
