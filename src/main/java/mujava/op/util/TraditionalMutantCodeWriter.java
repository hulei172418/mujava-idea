...
public class TraditionalMutantCodeWriter extends MutantCodeWriter{
    ...
    {
      if (MutationSystem.WHOLE_METHOD_NAMES.contains(method_signature)){
          CodeChangeLog.writeLog(class_name+ MutationSystem.LOG_IDENTIFIER
                  ...
                  + MutationSystem.CLASS_NAME_T + MutationSystem.LOG_IDENTIFIER
                  + MutationSystem.CLASS_NAME + MutationSystem.LOG_IDENTIFIER
                  + changed_content);
      }
    }
